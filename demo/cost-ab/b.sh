#!/usr/bin/env bash
# RIGHT column = imgtokenx (through the proxy on 47824). Launches an INTERACTIVE
...
echo "RIGHT = imgtokenx (:47824), model=$MODEL. Launching interactive Claude with the task..."
