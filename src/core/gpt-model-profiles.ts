 ...
 *
 *   IMGTOKENX_GPT_PROFILES='{"gpt-5.6-sol":{"vision":{"regime":"patch","multiplier":1,"patchCap":12000},"stripCols":120,"maxHeightPx":1900}}'
 *   IMGTOKENX_GPT_PROFILES='{"gpt-5.6-sol":{"style":{"grid":true,"gridCols":4}}}'
 */
...
const BUILTIN_RULES: ProfileRule[] = [
  ...
  // Opus 4.x needs the reader-calibrated 20x32 cell on every transport. Keep
  // the physical strip within Anthropic's 1568px no-resize edge: 78*20+8=1568.
  {
    ...
    profile: {
      ...
      style: { ...BASE_STYLE, cellWBonus: 15, cellHBonus: 24 },
    },
  },
