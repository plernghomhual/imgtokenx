 ...
 * Dense Anthropic pages are capped at 1568×728 px so Claude sees glyphs at
 * uploaded resolution instead of resizing a taller page before vision.
 */
...
/** Compatibility helper used by the reader-profile gate and renderer. */
export function cellDims(
  style: Pick<RenderStyle, 'font' | 'aa' | 'cellWBonus' | 'cellHBonus'>,
